#!/usr/bin/env bash
#
# Executa consultas analiticas no Athena.
#
# As consultas vivem em sql/<camada>/ como arquivos versionados. Qualquer
# pessoa com acesso ao Catalog reproduz os mesmos numeros — que e a
# diferenca entre um resultado apresentado e um resultado verificavel.
#
...
#   CAMADA=bronze bash scripts/consultar.sh              # outra camada
...
listar() {
  ...
  info "Outra camada: CAMADA=bronze bash scripts/consultar.sh"
  separador
}
